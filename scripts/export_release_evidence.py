...
import json,subprocess,uuid,xml.etree.ElementTree as ET
...
summary={"run_id":str(uuid.uuid4()),"commit_sha":None,"tests_total":total,"tests_passed":passed,"tests_failed":failed,"warnings":warnings,"security_findings":[],"state":"VERIFY" if failed==0 else "HOLD","timestamp":datetime.now(timezone.utc).isoformat()}
